...
const ChartWidget = ({
  ...
  // Set dynamic y-axis title if provided
  if (type !== 'pie') {
    options.yaxis.title = { text: yAxisTitle || 'GHG emissions (tCO2)', style: {
        color: yAxisTitleColor || COLOR_TEXT
      } }
  }
...
ChartWidget.propTypes = {
  ...
  yAxisTitle: PropTypes.string, // Added prop type for yAxisTitle
  yAxisTitleColor: PropTypes.string // Added prop type for yAxisTitleColor
}
