...
import { 
  ...
  uniqueVisitorsDataDay2,
  uniqueVisitorsDataDay3,
...
export const AnalyticDashboard = () => {
  ...
  const uniqueVisitorsData = uniqueVisitorsDataDay
  const uniqueVisitorsData2 = uniqueVisitorsDataDay2
  const uniqueVisitorsData3 = uniqueVisitorsDataDay3
    ...
    <>
      <Row gutter={16}>
        <Col xs={24} sm={24} md={24} lg={24} xxl={12}>
           <ChartWidget 
            ...
            title="Energy Supply and Contribution"  
            height={410}
            type="line"
            direction={direction}
            yAxisTitle="Energy (GWh)"  // Dynamic y-axis title
          />
        </Col>
        <Col xs={24} sm={24} md={24} lg={24} xxl={12}>
          {/* <DonutChartWidget 
          ...
          /> */}
          <ChartWidget 
            series={uniqueVisitorsDataDay2.series} 
            xAxis={uniqueVisitorsDataDay2.categories} 
            title="Emissions Saving by renewables on power generation"  
            height={410}
            type="line"
            direction={direction}
          />
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} sm={24} md={24} lg={24} xxl={18}>
           <ChartWidget 
            series={uniqueVisitorsData3.series} 
            xAxis={uniqueVisitorsData3.categories} 
            title="Savings due to the use of Natural Gas in Thermal"  
            height={410}
            type="line"
            direction={direction}
          />
        ...
        {/* <Col xs={24} sm={24} md={24} lg={24} xxl={12}>
          <ChartWidget 
            ...
            // extra={
            //   <Select defaultValue="week" size="small" style={{ width: 120 }} onChange={}>
